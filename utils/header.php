<header class="bgImage" style="background-image: url(images/bg.jpg);">
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
               ...
               if(is_logged_in()){
                ...
                //links non database contents. *if logged out
                    ...
                    echo '<li><a href = "contact.php">Contact Us</a></li>';
                    echo '<button type = "button" class = "btn btn-default navbar-btn" data-toggle = "modal" data-target = "#login">User Login <Span class="glyphicon glyphicon-log-in"></span></button>';
                    echo '<button type = "button" class = "btn btn-default navbar-btn" data-toggle = "modal" data-target = "#admin" style="
                    margin-left: 23px;">Admin Login <Span class="glyphicon glyphicon-log-in"></span></button>';
                }
                ?>
                ...
                <div class="modal fade" id="admin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--modal for login-->
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header"><!--modal header-->
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="myModalLabel">Admin Login</h4><!--modal title-->
                            </div>
                            <div class="row">
                                <div class="modal-body"><!--modal content-->
                                    <div class ="col-md-6 col-md-offset-3">
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>SMS EVENTS </h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're looking to book a wedding, birthday, celebratory function, conference, business
                meeting, or private dining event, our dedicated SMS Events team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
